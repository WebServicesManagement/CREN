...
(function() {
  ...
  Dropbox.Drivers.BrowserBase = (function() {
    ...
    BrowserBase.prototype.onAuthStateChange = function(client, done) {
      var credentials,
        _this = this;
    ...
    BrowserBase.prototype.storeCredentials = function(credentials) {
      return localStorage.setItem(this.storageKey, JSON.stringify(credentials));
    };

    BrowserBase.prototype.loadCredentials = function() {
      var jsonString;
    ...
    BrowserBase.prototype.forgetCredentials = function() {
  ...
  Dropbox.Drivers.Redirect = (function(_super) {
    ...
    Redirect.prototype.onAuthStateChange = function(client, done) {
      ...
      if (client.authState === DropboxClient.RESET) {
        if (credentials = this.loadCredentials()) {
          if (credentials.authState) {
            if (credentials.token === this.locationToken() && credentials.authState === DropboxClient.REQUEST) {
      ...
      return Redirect.__super__.onAuthStateChange.call(this, client, done);
    };
  ...
  Dropbox.Drivers.Popup = (function(_super) {
    ...
    Popup.prototype.onAuthStateChange = function(client, done) {
      var credentials;
      this.setStorageKey(client);
      if (client.authState === DropboxClient.RESET) {
        if (credentials = this.loadCredentials()) {
      ...
      return Popup.__super__.onAuthStateChange.call(this, client, done);
    };
